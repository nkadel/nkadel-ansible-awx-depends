#
# spec file for package rh-python36-python-selectors2
#
...
%changelog
* Sat Jul 6 2019 Nico Kadel-Garcia <nkadel@gmail.com> - 2.0.1-0
- Update .spec file with py2pack
- Manually set Suggests from dev-requirements.txt
