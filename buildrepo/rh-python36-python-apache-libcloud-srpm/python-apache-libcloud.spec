#
# spec file for package rh-python36-python-apache-libcloud
#
...
License:        Apache License (2.0) (FIXME:No SPDX)
...
%changelog
* Sun Jul 14 2019 Nico Kadel-Garcia <nkadel@gmail.com> - 2.2.1-0
