#
# spec file for package rh-python36-python-jedi
#
...
# Manually added
Requires:       %{?scl_prefix}python-parso >= 0.5.0
%if %{with_dnf}
#[testing]
Suggests:       %{?scl_prefix}python-pytest < 5.0.0
Suggests:       %{?scl_prefix}python-pytest >= 3.1.0
Suggests:       %{?scl_prefix}python-docopt
Suggests:       %{?scl_prefix}python-colorama
%endif # with_dnf
...
%changelog
* Sun Jul 14 2019 Nico Kadel-Garcia <nkadel@gmail.com> - 0.14.1-0
