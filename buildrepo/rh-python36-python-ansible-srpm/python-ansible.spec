...
%{_bindir}/bin/ansible
%{_bindir}/bin/ansible-config
%{_bindir}/bin/ansible-connection
%{_bindir}/bin/ansible-console
%{_bindir}/bin/ansible-doc
%{_bindir}/bin/ansible-galaxy
%{_bindir}/bin/ansible-inventory
%{_bindir}/bin/ansible-playbook
%{_bindir}/bin/ansible-pull
%{_bindir}/bin/ansible-vault
%{_bindir}/bin/ansible
%{_bindir}/bin/ansible-config
%{_bindir}/bin/ansible-connection
%{_bindir}/bin/ansible-console
